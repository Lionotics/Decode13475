...
@Config
@Autonomous(name = "RedTouchingWallNoShootingAuto", group = "Autonomous")
public class RedTouchingWallNoShooting extends AutoParent{
    ...
    protected int autonomousPathUpdate() {
        ...
        switch (pathState) {
            ...
            case 1:
                if (!follower.isBusy()) {
                    follower.turn(AngleUnit.normalizeRadians(Math.toRadians(-90)));
                    pathState = 2;
                }
                break;
        }
